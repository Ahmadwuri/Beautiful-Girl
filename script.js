document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "Waktu yang ku punya dengan mu" },
        { time: 4, text: "Kita berdansa dan tertawa" },
        { time: 6, text: "Gandeng tangan" },
        { time: 10, text: "Semoga bergema sampai selamanya" },
        { time: 17, text: "Dunia pasti ada akhirnya" },
        { time: 23, text: "Bintang bintang pun ada" },
        { time: 25, text: "Umurnya" },
        { time: 29, text: "Maka tenang saja kita disini" },
        { time: 32, text: "Berdua" },
        { time: 38, text: "Nikmati sementara yang ada" },
        { time: 44, text: "....." },
    ];
